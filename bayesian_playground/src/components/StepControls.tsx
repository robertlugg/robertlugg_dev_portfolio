...
import { Paper, Typography, Slider, TextField, Box, IconButton } from '@mui/material';
...
const StepControls: FC<StepControlsProps> = ({ stepIndex, setStepIndex, totalSteps, setTotalSteps }) => {
  ...
  return (
    <Paper sx={{ padding: 2, textAlign: 'center' }} tabIndex={0} onKeyDown={handleKeyDown}>
      <Typography variant="h6">Step Controls</Typography>

      {/* Slider Section: only numbers displayed */}
      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', mt: 2 }}>
        <Typography variant="body1" sx={{ mr: 1 }}>0</Typography>
        <Slider
          value={stepIndex}
